...
namespace FPS
{
    ...
    public static class RS485
    {
                    ...
                    if (iCheck > 0)
                    {
                        ...
                        if (iCheck > 2)
                        {
                           ...
                           // String str_cash = "";
                            if (true)
                            {
                                //str_cash = "" + iPicNum + " "+CenCom.scb+" " + sReceive;

                                //Write_cashMsg(str_cash);
       ...
       public static void Write_cashMsg(string sData)
        {
            File.AppendAllText("LOGS\\CashMsg_" + String.Format("{0:D2}", DateTime.Today.Day) + ".txt", sData);
        }
    ...
    public class PIC
    {
       ...
       public int iBillValue;
        ...
        public void ProcessMessage(string sPassReceive)
        {
                ...
                //Debug.WriteLine("PROCESS PIC MESSAGE: " + Convert.ToByte(sPassReceive));
        ...
        void SetBillValue(int iPassNewBill)
        {
            ...
            PIC.checkTwice = true;
            Debug.WriteLine("iBillValue="+ iBillValue);
        }
        ...
        void CountBill()
        {
            //RS485.Write_cashMsg(" New Bill scb value= " + CenCom.scb + " ");
        ...
        void ShowCashBalance(int iPassIndex, int iPassWait)
        {
           ...
           CenCom.scb++;
         // RS485.Write_cashMsg(CenCom.scb.ToString());
           Debug.WriteLine(sRequest + " " + CenCom.scb);
           Debug.Write("scb=" + CenCom.scb + " Bill Values=" + iDeposit);
            dtNewScreen = DateTime.Now;
            tsScreenLimit = TimeSpan.FromMilliseconds(iPassWait * 1000);
        }
